...
{
	WriteRegfdc2214(0x0B, 0xFFFF); //设置转换时间  设置达到最高精度
    WriteRegfdc2214(0x0F, 0x0F00); //调零

	WriteRegfdc2214(0x13, 0x0064); //FDC2214_SETTLECOUNT_CH3 计数

	WriteRegfdc2214(0x17, 0x2001); //分频洗系数
	WriteRegfdc2214(0x19, 0x0000); //ERROE_CONFIG

	WriteRegfdc2214(0x1B, 0x020F); //通道配置
	WriteRegfdc2214(0x21, 0xF800); //配置驱动电流
	WriteRegfdc2214(0x1A, 0xDC81); //参数配置 1101110010000001
}
/*******************************************************************************
